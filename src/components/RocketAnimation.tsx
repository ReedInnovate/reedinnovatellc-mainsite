...
const RocketAnimation = () => {
  ...
  return <div className="flex flex-col md:flex-row h-[400px] w-full border border-gray-200 rounded-xl overflow-hidden shadow-md bg-white">
      {/* Text side - 50% width */}
      <div className="w-full md:w-1/2 p-6 flex flex-col justify-center">
        ...
        <div className="flex flex-col gap-2 mt-4">
          {stages.map(stage => <div key={stage.title} className="flex items-center gap-2">
              <div className={cn("w-4 h-4 rounded-full flex-shrink-0", stage.title === currentStage ? "bg-primary" : "bg-gray-200")} />
              <span className={cn("text-sm capitalize", stage.title === currentStage ? "text-primary font-medium" : "text-gray-500")}>
                {stage.title}
              </span>
              {stage.title === currentStage && <div className="flex-grow h-1 bg-gray-100 rounded overflow-hidden">
      ...
      <div className="w-full md:w-1/2 bg-gradient-to-b from-blue-600 to-blue-900 relative overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2">
          {/* Cloud/Smoke base */}
          <div className={cn("absolute bottom-0 left-1/2 transform -translate-x-1/2 w-80 h-16 bg-white rounded-full opacity-70 transition-opacity duration-700", currentStage === 'launch' || currentStage === 'grow' ? "opacity-70" : "opacity-0")}></div>
          
          {/* Space Shuttle Components */}
          <div className={cn("transition-all duration-700", currentStage === 'discover' ? "opacity-30" : "opacity-100", currentStage === 'grow' && `translate-y-[-${progress * 2}px]`)} style={{
          transform: currentStage === 'grow' ? `translateY(-${progress * 2}px)` : 'translateY(0)'
            ...
            <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2 w-24 h-48 rounded-t-full shadow-lg">
              ...
              <div className="w-full h-full rounded-t-full bg-gradient-to-r from-gray-300 via-white to-gray-300 relative overflow-hidden">
                ...
                <div className="absolute inset-0 grid grid-cols-8 grid-rows-16 gap-[1px]">
                  {Array.from({
                  length: 128
                }).map((_, i) => <div key={i} className={cn("bg-gray-200 opacity-50", i % 2 === 0 ? "bg-gray-300" : "bg-gray-200")}></div>)}
                </div>
              ...
              <div className={cn("absolute top-1/2 left-0 w-10 h-6 -translate-x-[80%] skew-y-[15deg] transition-opacity duration-500", currentStage === 'discover' ? "opacity-0" : "opacity-100")}>
              ...
              <div className={cn("absolute top-1/2 right-0 w-10 h-6 translate-x-[80%] skew-y-[-15deg] transition-opacity duration-500", currentStage === 'discover' ? "opacity-0" : "opacity-100")}>
            ...
            <div className={cn("absolute bottom-16 left-1/2 transform -translate-x-1/2 w-12 h-44 rounded-t-full rounded-b-lg transition-opacity duration-500", currentStage === 'discover' ? "opacity-0" : "opacity-100")} style={{
            zIndex: -1
          }}>
            ...
            <div className={cn("absolute bottom-16 left-1/2 flex justify-between transition-opacity duration-500", currentStage === 'discover' || currentStage === 'strategize' ? "opacity-0" : "opacity-100")} style={{
            width: '70px',
          ...
          <div className={cn("absolute transition-all duration-700", currentStage === 'launch' || currentStage === 'grow' ? "opacity-100" : "opacity-0")} style={{
          bottom: currentStage === 'grow' ? 'auto' : '0',
          transform: currentStage === 'grow' ? `translate(-50%, ${-progress * 2 + 100}px)` : 'translate(-50%, 0)',
          left: '50%'
        }}>
            ...
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-10 h-28">
              ...
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-3 h-16 bg-white rounded-t-full animate-flicker opacity-50" style={{
            ...
            <div className="absolute bottom-0 left-1/2 transform -translate-x-[35px] w-8 h-20">
              ...
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-4 h-14 bg-yellow-400 rounded-t-full animate-flicker opacity-70" style={{
          ...
          <div className={cn("absolute bottom-0 left-1/2 transform -translate-x-1/2 w-80 h-16 transition-opacity duration-700", currentStage === 'discover' || currentStage === 'strategize' ? "opacity-0" : currentStage === 'grow' ? "opacity-0" : "opacity-100")}>
            {/* Left tower */}
          ...
          {(currentStage === 'launch' || currentStage === 'grow') && <>
              ...
              <div className="absolute bottom-5 left-1/2 transform -translate-x-[50px] w-24 h-12 bg-white rounded-full opacity-50 animate-pulse" style={{
            animationDelay: '300ms'
          }}></div>
              <div className="absolute bottom-8 left-1/2 transform translate-x-[40px] w-18 h-9 bg-white rounded-full opacity-30 animate-pulse" style={{
            animationDelay: '150ms'
          }}></div>
              
              <div className="absolute bottom-4 left-1/2 transform -translate-x-[30px] w-15 h-8 bg-white rounded-full opacity-60 animate-pulse" style={{
            animationDelay: '220ms'
          }}></div>
              <div className="absolute bottom-6 left-1/2 transform translate-x-[20px] w-16 h-8 bg-white rounded-full opacity-50 animate-pulse" style={{
