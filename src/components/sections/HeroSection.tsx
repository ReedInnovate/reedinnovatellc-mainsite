      ...
      <div className="container mx-auto px-4 md:px-6 pt-16 md:pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-4 md:space-y-6 text-center lg:text-left">
            <h1 className="sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl tracking-tight animate-fade-in-left font-normal text-left text-6xl">
              From Liftoff <br />to Orbit.
            </h1>
            <p style={{
            animationDelay: '200ms'
          }} className="md:text-xl lg:text-2xl text-gray-600 max-w-lg mx-auto lg:mx-0 animate-fade-in-left text-lg font-normal text-left">
