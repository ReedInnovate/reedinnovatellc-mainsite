...
import { Search, MessageSquare, Target, ArrowUpRight, Rocket, ScrollText, Zap, BarChart3, PenTool } from 'lucide-react';
const serviceItems = [{
  ...
  return <AnimatedSection id="together" className="bg-gray-50 py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center mb-10 md:mb-16">
          <h2 className="section-title md:text-4xl text-6xl">Let's work together</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {serviceItems.map((service, index) => <div key={index} className="glass-panel rounded-xl p-4 md:p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1" style={{
