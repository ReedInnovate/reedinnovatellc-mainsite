          ...
          <div className="order-2 lg:order-1">
            <div className="h-auto md:h-[300px] w-full mx-auto border border-gray-200 rounded-xl overflow-hidden shadow-md bg-white p-4 md:p-5">
              <div className="flex flex-col h-full">
                <h3 className="text-xl font-bold mb-4 md:text-3xl">Go-To-Market Journey</h3>
                ...
                <div className="flex justify-between items-center mt-auto">
                  {stages.map(stage => <div key={stage.title} className={cn("flex flex-col items-center transition-all duration-300", stage.title === currentStage ? "scale-110" : "opacity-60")}>
                      ...
                      <span className={cn("text-xs md:text-sm font-medium capitalize", stage.title === currentStage ? "text-primary" : "text-gray-500")}>
                        {stage.title}
                      </span>
                    </div>)}
                </div>
