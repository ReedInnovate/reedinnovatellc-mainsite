    ...
    <AnimatedSection id="you" className="bg-gray-50 py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-left md:text-center mb-10 md:mb-16">
          ...
          <p className="section-description mx-0 md:mx-auto text-left md:text-center text-lg md:text-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-4 md:space-y-6 order-1 lg:order-2">
            <h3 className="text-3xl md:text-4xl font-light text-left">You Need</h3>
